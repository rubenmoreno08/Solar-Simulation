...
* **Anàlisi de Tilt**: S'ha programat una iteració per trobar l'angle d'inclinació òptim (27 graus) que maximitza el rendiment anual[cite: 1].
* **Relleu i Ombres**: El model preveu l'impacte d'obstacles orogràfics en la captació d'energia[cite: 1].
